...
simple_britain_stopwords = ['since ', 'gentlelady', 'house lord', 'supplementary', 'questioned', ' united kingdom', 'please', 'section', 'prime minister', 'questions', 'ladies', 'hon memb', 'parliament', 'like ', 'hope wil', 'iii', 'years ago', 'Answers To Questions', ' home secretari', 'vote', 'member ', 'republican', 'mps', 'friend', 'congresswoman', ' secretary state', 'Speaker', 'friend memb', 'chair', 'senator', 'congresswomen', 'Commons', ' member', 'secretary st', 'billion', 'Council', 'right hon', ' will', 'opposition', 'motions', 'asked', 'opposite', 'chairman', 'uk', 'congressman', 'parties', 'asks', 'governments', 'leader', 'ii', 'exminister', 'government', 'country', 'senate', 'yield', 'pursuant', 'sections', 'year', 'minister', 'hon.', 'prime', 'Gentleman', 'floor', 'yes', 'years', 'order', 'bill', 'gentleman', ' think', 'hon friend', 'local author', 'congressmen', 's', 'i', 'deputy', 'last year', 'mr', 'ladi', 'mp', 'colleagues', 'congress', ' ladi', 'madam', 'memb', ' group', 'committee', 'british', '£ million', 'prime minist', 'supply', 'united kingdom', 'votes', 'colleague', ' look', 'per cent', 'Minister', 'chairmanship', 'secretary', 'clause', 'state', 'hon', 'secretary state', 'ministers', 'party', 'britain', 'demo- crat', 'speaker', ' per cent', '£ billion', 'members', 'motion', 'House', 'question', 'million', 'ask', 'bills', ' house lord', 'lady', 'member', 'sir', 'amendment', ' although', 'gentlemen', 'Oral', 'hon. Gentleman', 'house']
...
simple_britain_stopwords_stem = [stemmer.stem(word.lower()) for word in simple_britain_stopwords]

'''speakers_stem = [stemmer.stem(word.lower()) for word in speakers]'''

stopwords_stem = [word for word in english_stopwords_stem] + [word for word in simple_britain_stopwords_stem] #+ [word for word in speakers_stem]
...
def clean(text: str, gram:str):
  ...
  filtered_words = [word for word in tokens_stemmed if not word.lower() in stopwords_stem and len(word) >3]
  if (gram == 'bigram'):
